                        ...
                        foreach ($products as $row) { ?>
                            <li class="col-sx-12 col-sm-4">
                                <div class="product-container">
                                    ...
                                    <a href="#" data-toggle="modal" data-target="#my_modal" data-row-id='{"product_id":"<?php echo ($row['product_id']); ?>","product_name":"<?php echo ($row['product_name']); ?>","price":"<?php echo ($row['price']); ?>","product_img1":"<?php echo base_url($row['product_img1']); ?>"}'>
