    ...
    <div class="container" id="columns">
        ...
        <div class="row">
            ...
            <div class="center_column col-xs-12 col-sm-9" id="center_column">
                <!-- page heading-->
                <h2 class="page-heading no-line"><span class="page-heading-title2">แก้ไขสาขา</span></h2>
                <!-- ../page heading-->
	...
	<div class='modal-dialog' role='document'>
		<div class='modal-content'>
            ...
            <button type="button" style="background-color: #5a6268; color: #FFFFFF" class="btn btn-secondary" data-dismiss="modal">&nbsp;&nbsp;<i class="fa fa-close"></i> &nbsp;ปิด &nbsp;&nbsp;</button>&emsp;
				<button type="button" class="btn btn-success" id="btnSaveEditฺBranch">&nbsp;&nbsp;<i class="fa fa-save"></i> &nbsp;บันทึก &nbsp;&nbsp;</button>
			</div>
		</div>
	</div>
</div>