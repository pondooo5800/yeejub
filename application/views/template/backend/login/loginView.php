        ...
        <div class="row d-flex">
            <div class="col-lg-6">
                <div class="card1 pb-5">
                    <div class="row"> <img src="{base_url}/assets/images/logo.png" class="logo" > </div>
                    <div class="row px-3 justify-content-center mt-4 mb-5 border-line"> <img src="{base_url}/assets/images/icon.png" class="image"> </div>
                </div>
            </div>
			<br>
            <div class="col-lg-6">
                <div class="card2 card border-0 px-4 py-5">
                    <div class="row mb-4 px-3">
						<h4 style="font-weight: bold;text-align: center;color:#0062cc">ระบบบริหารจัดการยิมมวยออกกําลังกาย</h4>
                    </div>
                    <div class="row mb-4 px-3">
					<h5 style="font-weight: bold;text-align: center;color:#0062cc">Kick Fit Boxing Club</h5>
                    </div>
                    <div class="row px-3 mb-4">
                        <div class="line"></div> <small class="or text-center">By</small>
                        <div class="line"></div>
                    </div>
