		...
		<div class="col-md-12">
			<div class="card">
				...
				<form class='form-horizontal' id='formEdit' accept-charset='utf-8'>
						...
						<div class="container">
							<div class="form-row justify-content-around">
								<div class="form-group col-md-4 ">
									<label class="control-label" for="popup_name">ชื่อ  :</label>
									<div class="form-group has-info">
										<input type="text" class="form-control" id="popup_name" name="popup_name" value="{record_popup_name}" />
									</div>
								</div>
								<div class="form-group col-md-4 ">
							...
							<div class="form-row justify-content-around">
								<div class="col-sm-12 col-md-10">
									<label class="control-label" for="popup_img1">รูปภาพ  :</label>
									<div class="upload-box">
										<div class="hold input-group">
											<span class="btn-file"> คลิกเพื่อแนบไฟล์
												<input type="file" id="popup_img1" name="popup_img1" data-elem-preview="popup_img1_preview" data-elem-label="popup_img1_label" />
											</span><input class="form-control" id="popup_img1_label" name="popup_img1_label" placeholder=" กรุณาเลือกไฟล์ที่ต้องการอัพโหลด" readonly="readonly" value="{record_popup_img1_label}" />
										</div>
									</div>
									<br>
									{preview_popup_img1}
									<input type="hidden" id="popup_img1_old_path" name="popup_img1_old_path" value="" />
						...
						<input type="hidden" name="encrypt_popup_id" value="{encrypt_popup_id}" />
