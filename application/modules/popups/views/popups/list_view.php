		...
		<div class="col-md-12">
			<div class="card">
				<div class="card-header card-header-info card-header-icon">
					...
					<h4 class="card-title">ตั้งค่า Popup</h4>
				</div>
				<div class="card-body">
									...
									<div class="col-md-2">
										<div class="form-group has-warning bmd-form-group" id="search">
											<select class="select2-search" name="search_field" class="span2">
												<option value="popup_name">ชื่อ</option>
											</select>
										</div>
									</div>
									<div class="col-md-2">
									...
									<div class="col-md-2">
										<div class="form-group bmd-form-group">
											<select class="select2-search" id="set_order_by" class="span2" value="{order_by}">
												...
												<option value="popup_name|asc">ชื่อ ก - ฮ</option>
												<option value="popup_name|desc">ชื่อ ฮ - ก</option>
											</select>
										</div>
									</div>
									<div class="col-md-2">
						...
						<table class="table table-striped">
							...
							<tbody>
								<tr parser-repeat="[data_list]" id="row_{record_number}">
									...
									<td style="text-align:left;">{popup_name}</td>
									...
									<td class="td-actions text-center">
										...
										<a href="javascript:void(0);" class="btn-delete-row my-tooltip btn btn-danger" data-toggle="tooltip" title="ลบรายการนี้" data-popup_id="{encrypt_popup_id}" data-row-number="{record_number}">
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<form id="formDelete">
					<input type="hidden" name="encrypt_popup_id" />
				</form>
			</div>
