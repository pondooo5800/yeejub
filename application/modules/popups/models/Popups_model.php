...
class Popups_model extends MY_Model
{
	...
	{
		$popup_id = checkEncryptData($data['popup_id']);
		$this->set_where("$this->my_table.popup_id = $popup_id");
	...
	{
		$this->set_where("$this->my_table.popup_id = $id");
	...
	{
		$data = array(
			'popup_name' => $post['popup_name'],
			'popup_img1' => $post['popup_img1'],
	...
	public function update($post)
	{
		...
		if (isset($post['popup_img1'])) {
			$data['popup_img1'] = $post['popup_img1'];
		}


		$popup_id = checkEncryptData($post['encrypt_popup_id']);
		$this->set_where("$this->my_table.popup_id = $popup_id");
