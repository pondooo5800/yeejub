	...
	<div class="row">
		<div class="col-md-12">
			<div class="card">
						...
						<div class="container">
							<div class="form-row justify-content-around">
								<div class="form-group col-md-4">
									<label class="control-label" for="product_type_name">ชื่อหมวดหมู่สินค้า :</label>
									<div class="form-group has-info">
										<input type="text" class="form-control" id="product_type_name" name="product_type_name" value="{record_product_name}" />
									</div>
								</div>
								<div class="form-group col-md-4">
				...
				<input type="hidden" name="encrypt_product_type_id" value="{encrypt_product_type_id}" />
