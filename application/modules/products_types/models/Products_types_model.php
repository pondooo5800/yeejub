...
class Products_types_model extends MY_Model
{
	...
	{
		parent::__construct();
		$this->my_table = 'tb_products_types';
	...
	{
		$product_type_id = checkEncryptData($data['product_type_id']);
	...
	{
		$this->set_where("$this->my_table.product_type_id = $id");
