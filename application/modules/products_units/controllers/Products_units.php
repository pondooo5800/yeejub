...
class Products_units extends CRUD_Controller
{
	...
	public function formValidate()
	{
		...
		$frm->set_rules('product_unit_name', 'ขื่อหน่วยสินค้า', 'trim|required');
	...
	public function update()
	{
		...
		if ($message != '') {
			...
			if ($result == false) {
				...
				$message = '<strong>บันทึกข้อมูลเรียบร้อย</strong>' . $this->Products_units->error_message;
				$ok = TRUE;
			}
			$json = json_encode(array(
				'is_successful' => $ok,
