							...
							<tbody>
								<tr parser-repeat="[data_list]" id="row_{record_number}">
									...
									<td class="td-actions text-center">
										...
										<a href="javascript:void(0);" class="btn-delete-row my-tooltip btn btn-danger" data-toggle="tooltip" title="ลบรายการนี้" data-banner_id="{encrypt_banner_id}" data-row-number="{record_number}">
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<form id="formDelete">
					<input type="hidden" name="encrypt_banner_id" />
				</form>
			</div>
