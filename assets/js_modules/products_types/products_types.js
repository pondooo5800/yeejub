...
var Products_types = {
	...
	loadPreview: function(id){
		$.ajax({
			method: 'GET',
			url: site_url('products_types/products_types/preview/'+ id),
	...
	saveEditForm: function(){
		...
		var frm_action = site_url('products_types/products_types/update');
	...
	confirmDelete: function (pProductId,  irow){
		$('[name="encrypt_product_type_id"]').val(pProductId);
	...
	deleteRecord: function(){
		var frm_action = site_url('products_types/products_types/del');
		...
		$.ajax({
			...
			success: function (results) {
				if(results.is_successful){
					alert_type = 'success';
					setTimeout(function(){
						$(window.location).attr('href', site_url('products_types/products_types/index/'+ this.current_page));
					}, 500);
				}else{
					alert_type = 'danger';
				}
...
$(document).ready(function() {
	...
	$('#btnSaveEdit').click(function() {
		return Products_types.validateFormEdit();
	});//click
	...
	if(typeof param_current_page != 'undefined'){
		Products_types.current_page = Math.abs(param_current_page);
	}
	...
	$(document).on('click','.btn-delete-row', function(){
		...
		Products_types.confirmDelete(pProductId,  row_num);
	});//click

	$(document).on('click','#btn_confirm_delete', function(){
		Products_types.deleteRecord();
	});
